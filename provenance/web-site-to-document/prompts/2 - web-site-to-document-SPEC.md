...
- Solo il dominio esatto di partenza (es. `help.example.com`)
- Dominio + sottodomini (es. `*.example.com`)
...
```
Esempi:
- `help_example_com_20260409_full.docx`
- `help_example_com_20260409_3livelli.pdf`
- `learn_example_com_20260409_full.md`
...
|---|---|---|
| `help.example.com/erp/docs/...` | Documentazione ERP | JS-rendered, struttura profonda |
| `help.example.com/doc/...` | API Reference | Potenzialmente molto grande |
| `help.example.com/addon/` | Documentazione prodotto | Struttura da analizzare |
| `help.example.com/addon-mfg/` | Documentazione prodotto | Struttura da analizzare |
| `help.example.com/addon-scripting/` | Documentazione scripting | Potrebbe contenere molti blocchi di codice |
| `learn.example.com/docs/...` | Documentazione vendor | JS-rendered, struttura molto profonda |

---

## 10. Vincoli e Limitazioni Note

1. **Network egress**: alcuni domini potrebbero essere bloccati dalle impostazioni di rete dell'ambiente di esecuzione. La skill non può aggirare queste restrizioni; può solo rilevare il blocco e informare l'utente.
